...
public class Board {
    ...
    //kiá»ƒm tra vá»‹ trÃ­ cÃ³ há»£p lá»‡ khÃ´ng
    ...
    //kiá»ƒm tra quÃ¢n cá»� cÃ³ Ä‘Æ°á»£c Ä‘i chÃ©o khÃ´ng
    ...
    public static void drawNextMove(Graphics2D g2d) {
        if (listNextMove.size() > 0) {
            for (nextMove m : listNextMove) {
                g2d.setColor(Color.orange);
                g2d.fillRoundRect(60 + (m.getY() - 1) * 150 - 15, 60 + (m.getX() - 1) * 150 - 15, 30, 30, 45, 45);
            }
        }
    }
